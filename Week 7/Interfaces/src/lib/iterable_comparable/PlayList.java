...
public class PlayList implements Iterable<Song> {
    ...
    private final List<Song> songlist; //collection of songs
    ...
    public String getTrackListings() {
    	StringBuilder s = new StringBuilder("PlayList: " + this.name + "\n");
        
        for (int i = 0; i < songlist.size(); i++) {
            s.append(i + 1).append("\t").append(songlist.get(i).toString()).append("\n");
        }
        return s.toString();
    }
