...
public class RegisterTest {
	...
	public void testDefaultConstructor() {
		assertTrue("Register should be empty", r.isRegisterEmpty());
	...
	public void testSearchRegisterByFamilyName() {
		...
		assertFalse("Fourth search should not find Bloggs, i.e. return false", r.searchRegisterByFamilyName("Bloggs"));
	}
